...
//User id form
type Id struct {
	Id int64 `form:"id" json:"user_id" binding:"required"`
}
type Plan_Id struct {
	Id int64 `form:"id" json:"plan_id" binding:"required"`
}
type Activity_Id struct {
	Id int64 `form:"id" json:"activity_id" binding:"required"`
}
type Family_Id struct {
	Id int64 `form:"id" json:"family_id" binding:"required"`
}

type FamilyForm struct {
	Name     string `form:"name" json:"name"`
	Admin_id int    `form:"admin_id" json:"admin_id"`
}
type RequestAddFamilyForm struct {
	Family_id int `form:"family_id" json:"family_id"`
	Admin_id  int `form:"admin_id" json:"admin_id"`
	User_id   int `form:"person_id" json:"person_id"`
}

type ConfirmRequestAddFamilyForm struct {
	Family_id int `form:"family_id" json:"family_id"`
	Admin_id  int `form:"admin_id" json:"admin_id"`
	User_id   int `form:"person_id" json:"person_id"`
	Confirm   int `form:"isConfirm" json:"isConfirm"`
}
